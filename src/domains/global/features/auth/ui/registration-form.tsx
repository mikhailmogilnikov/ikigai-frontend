...
import { OtpInputModal } from '~/shared/ui/overlays/otp-input-modal';
...
export function RegistrationForm({ className }: { className?: string }) {
  ...
  return (
    <>
      <OtpInputModal
        open={isOtpInputModalOpen}
        onOpenChange={onOtpInputModalOpenChange}
        onSubmit={onOtpInputModalSubmit}
        errorsCount={otpErrorsCount}
